...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // The main MaterialApp widget that wraps the entire application
    return MaterialApp(
      debugShowCheckedModeBanner: false, // Disable the debug banner
      home: HomeScreen(
          username: "Maya Ramon"), // Set the HomeScreen and pass the username
    );
  }
}
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget sleepSettingCard(String title, String time, IconData icon,
